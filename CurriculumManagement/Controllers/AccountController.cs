...
namespace CurriculumManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddCWLLogin()
        {
            CWLLogin login = new CWLLogin();
            return View("AddCWLLogin", login);
        }

        [HttpPost]
        public ActionResult AddCWLLogin(CWLLogin login)
        {
            //Create test users
            var user = new ApplicationUser();
            user.UserName = login.LoginId;
        ...
        public ActionResult LogOff(int? id)
        {
            ...
            return Redirect(WebConfigurationManager.AppSettings["LogoutUrl"].ToString());
        }
        //
        // POST: /Account/LogOff
        [HttpPost]
